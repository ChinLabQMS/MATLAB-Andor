...
images= load ('data\r=50_darkspot_onatoms_centered.mat').Data.Andor19330.Image;
...
signals = double(images);

%% Averaged Image of the second shot (and of the first shot)
avgd=mean(signals,3);
figure
imagesc(avgd)
title('Averaged image of r=50 dark spot pattern projected onto atoms')
%% Get cross sections and find the intensity peak in the second shot
avgdshot2=avgd(100:500,300:700); % this is to crop the second shot
figure
imagesc(avgdshot2)
title('Averaged image of r=50 dark spot pattern projected onto atoms shot 2 cropped')
[m,id]=maxk(avgdshot2,10)
