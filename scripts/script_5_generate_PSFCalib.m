...
clear; clc; close all
p = PSFCalibrator( ...
    "DataPath", "data/2025/06 June/20250602/psf.mat", ...
...
%% (Optional) Zelux
close all
p.fit('Zelux', 1, 2,'bin_threshold_max', 30, 'filter_intensity_min', 10, 'plot_diagnostic', 1)
...
%% Zelux
close all
p.fit('Zelux', [], 2, 'bin_threshold_max', 30, 'filter_intensity_min', 10, 'verbose', 1)
