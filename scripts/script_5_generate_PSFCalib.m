...
clear; clc; close all
p = PSFCalibrator( ...
    "DataPath", "data/2025/02 February/20250218 DMD focus scan/end_of_day_sparse_r=3.mat", ...
...
%% Zelux
close all
p.fit('Zelux', 1, 2, 'plot_diagnostic', 1)
...
%% Zelux
p.fit('Zelux', [], 2, 'filter_gausswid_max', inf, 'verbose', 1)
