    ...
    methods
        ...
        function plot(obj, opt)
            arguments
                ...
                opt.surface_sub_sample = obj.Update_GaussFitSubSample
            ...
            title(sprintf('Ideal Airy PSF, sigma = %.3g', obj.RayleighResolution/2.9))
            lims = clim;
            ax2 = subplot(2, 3, 2);
...
function [val, step_range] = findPSFLineCut(psf, amp, v, step_range)
