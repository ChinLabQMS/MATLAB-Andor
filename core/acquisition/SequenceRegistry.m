    ...
    properties (Constant)
        ...
        Full4TimingTestZelux = makeSequence( ...
            ["Zelux", "Zelux", "Zelux", "Zelux", ...
             ...
             "Andor19331", "Andor19331", "Andor19330"], ...
            ["Lattice_935", "Pattern_532", "Lattice_935", "Pattern_532", ...
             "White", "Sequence", "Black", "PreloadedPattern", ...
             "Image", "Image", ...
             "Image", "Image", ...
             "Image", "Image", "Image"], ...
            ["Start+Acquire", "Start+Acquire", "Analysis", "Analysis", ...
        ...
        Full4TimedAnalysis = makeSequence( ...
            ["Zelux", "Zelux", "Zelux", "Zelux", ...
             ...
             "Andor19331", "Andor19331", "Andor19330"], ...
            ["Lattice_935", "Pattern_532", "Lattice_935", "Pattern_532", ...
             "FirstPattern", "Sequence", "LastPattern", ...
             "SamplePrep", "", ...
             "Image", "Image", ...
             "Image", "Image", ...
             "White", "DMDSequence", "Black", ...
             "Image", "Image", "Image"], ...
            ["Start+Acquire", "Start+Acquire", "Analysis", "Analysis", ...
             "Project", "Project", "Project", ...
             "Project", "Project", ...
            ...
            ["", "", "", "", ...
             ...
             "", "", ...
             "Preprocess; fast_mode=1", ...
                "ReconstructSites; calib_mode='none'; add_description=0; classify_method='fixed'; fixed_thresholds=400", ...
             "mode=""SolidColor""; red=255; green=255; blue=255", ...
             "mode=""DynamicPreloaded""; pattern_index=[0, 1, 2]", ...
             "mode=""SolidColor""; red=0; green=0; blue=0", ...
             "", ...
        ...
        Full4TimedFeedback = makeSequence( ...
            ["Zelux", "Zelux", "Zelux", "Zelux", ...
             "DMD",   "DMD",   "DMD", ...
             "DMD", "--inactive--", ...
             "Andor19330", "Andor19331", "Andor19330", "--inactive--", ...
             "DMD", ...
             "Andor19331", "Andor19331", "Andor19330"], ...
            ["Lattice_935", "Pattern_532", "Lattice_935", "Pattern_532", ...
             "Black1", "Sequence", "Black2", ...
             "SamplePrep", "", ...
             "Image", "Image", "Image", "DMDBlack", ...
             "DMDSequence", ...
             "Image", "Image", "Image"], ...
            ["Start+Acquire", "Start+Acquire", "Analysis", "Analysis", ...
             "Project", "Project", "Project", ...
             "Project", "Project", ...
             "Start", "Start", "Acquire", "Project", ...
             "Project", ...
             "Acquire", "Analysis", "Analysis"], ...
            ["", "", "", "", ...
             "mode=""SolidColor""; red=0; green=0; blue=0", ...
                ...
                "mode=""SolidColor""; red=0; green=0; blue=0", ...
             "mode=""DynamicPreloaded""; pattern_index=4", "", ...
             "", "", "Preprocess; fast_mode=1", "mode=""SolidColor""; red=0; green=0; blue=0", ...
             "mode=""DynamicPreloaded""; pattern_index=[5, 6, 7, 8, 9]", ...
             "", "CalibLatR; UpdateDeconvWeight; ReconstructSites; calib_mode='none'; AnalyzeOccup; hist_params=50", ""])
    end
