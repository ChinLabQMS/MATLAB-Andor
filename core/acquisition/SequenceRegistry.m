classdef SequenceRegistry
    ...
    properties (Constant)
        ...
        Sequence4Analysis = table( ...
            (1:12)', ...
            categorical({'Andor19330', 'Andor19331', 'Zelux', 'Zelux', 'Andor19330', 'Andor19331', 'Andor19330', 'Andor19331', 'Zelux', 'Zelux', '--inactive--', '--inactive--'}, ...
            {'Andor19330', 'Andor19331', 'Zelux', '--inactive--'}, 'Ordinal', true)', ...
            ["Image", "Image", "Lattice", "DMD", "Image", "Image", "Image", "Image", "Lattice", "DMD", "", ""]', ...
            categorical({'Start', 'Start', 'Start+Acquire', 'Start+Acquire', 'Acquire', 'Acquire', 'Analysis', 'Analysis', 'Analysis', 'Analysis', 'Analysis', 'Analysis'}, ...
            {'Start+Acquire', 'Start', 'Acquire', 'Analysis'}, 'Ordinal', true)', ...
            ["", "", "", "", "", "", "FitCenter, CalibLatR", "FitCenter, CalibLatR", "CalibLatR", "FitCenter", "", ""]', ...
            'VariableNames', {'Order', 'Camera', 'Label', 'Type', 'Note'})
    end
