classdef SequenceRegistry < BaseObject %#ok<*AGROW>
    ...
    properties (Constant)
        ...
        Full4Analysis = table( ...
            ...
            'VariableNames', {'Order', 'Camera', 'Label', 'Type', 'Note'})
        Full4Analysis2 = table( ...
            (1:14)', ...
            categorical({'Zelux', 'Zelux',  'Zelux', 'Zelux', 'Zelux', 'Zelux', 'Andor19330', 'Andor19331', 'Andor19330', 'Andor19331', 'Andor19330', 'Andor19331', '--inactive--', '--inactive--'}, ...
            {'Andor19330', 'Andor19331', 'Zelux', '--inactive--'}, 'Ordinal', true)', ...
            ["Lattice", "DMD", "Lattice", "DMD", "Lattice", "DMD", "Image", "Image", "Image", "Image", "Image", "Image", "", ""]', ...
            categorical({'Start', 'Start', 'Acquire', 'Acquire', 'Analysis', 'Analysis', 'Start', 'Start', 'Acquire', 'Acquire', 'Analysis', 'Analysis', 'Analysis', 'Analysis'}, ...
            {'Start+Acquire', 'Start', 'Acquire', 'Analysis'}, 'Ordinal', true)', ...
            ["", "", "", "", "CalibLatR", "FitCenter", "", "", "", "", "FitCenter, CalibLatR", "FitCenter, CalibLatR", "", ""]', ...
            'VariableNames', {'Order', 'Camera', 'Label', 'Type', 'Note'})
    end
