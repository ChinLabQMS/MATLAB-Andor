classdef SequenceRegistry < BaseObject
    ...
    properties (Constant)
        ...
        Full4AnalysisPSF = makeSequence( ...
            ["Picomotor",  "Picomotor",  "Picomotor",  "Picomotor",  ...
             "Zelux",      "Zelux",      "Zelux",      "Zelux",   ...
             "Andor19330", "Andor19331", "Andor19330", "Andor19331", "Andor19330", "Andor19331"], ...
            ...
            ["Move",       "Move",       "Move",       "Move", ...
             "Start+Acquire", "Start+Acquire", "Analysis", "Analysis", ...
             "Start",      "Start",      "Acquire",    "Acquire",    "Analysis",   "Analysis"], ...
            ["channel=1; scan=true; scan_start=-10; scan_num_step=10; scan_step_size=1", ...
             "channel=2; scan=true; scan_start=-10; scan_num_step=10; scan_step_size=1", ...
             "channel=3; scan=true; scan_start=-10; scan_num_step=10; scan_step_size=1", ...
             "channel=4; scan=true; scan_start=-10; scan_num_step=10; scan_step_size=1", ...
