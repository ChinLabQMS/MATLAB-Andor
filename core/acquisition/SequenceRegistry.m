    ...
    properties (Constant)
        ...
        Full4AnalysisPSF = makeSequence( ...
            ...
            ["Move",       "Move",       "Move",       "Move", ...
             "Start+Acquire", "Start+Acquire", "Analysis", "Analysis", ...
             "Start",      "Start",      "Acquire",    "Acquire",    "Analysis",   "Analysis"], ...
            ["channel=1; scan=true; scan_start=0; scan_num_step=10; scan_step_size=1", ...
             "channel=2; scan=true; scan_start=0; scan_num_step=10; scan_step_size=1", ...
             "channel=3; scan=true; scan_start=0; scan_num_step=10; scan_step_size=1", ...
             "channel=4; scan=true; scan_start=0; scan_num_step=10; scan_step_size=1", ...
