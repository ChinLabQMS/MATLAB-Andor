classdef SequenceExample
    ...
    properties (Constant)
        Empty {mustBeValidSequence} = table( ...
            (1:10)', ...
        ...
        Sequence4Basic {mustBeValidSequence} = table( ...
            (1:10)', ...
            categorical({'Andor19330', 'Andor19331', 'Zelux', 'Zelux', 'Andor19330', 'Andor19331', '--inactive--', '--inactive--', '--inactive--', '--inactive--'}, ...
            {'Andor19330', 'Andor19331', 'Zelux', '--inactive--'}, 'Ordinal', true)', ...
            ["Image", "Image", "Lattice", "DMD", "Image", "Image", "", "", "", ""]', ...
        ...
        Sequence4Analysis {mustBeValidSequence} = table( ...
            ...
            {'Start+Acquire', 'Start', 'Acquire', 'Analysis'}, 'Ordinal', true)', ...
            ["", "", "", "", "CalibLat", "FitPSF", "BigAxes1", "BigAxes2", "FitGauss, CalibLat, CalibDMD", "FitGauss, FitPSF", "", ""]', ...
            'VariableNames', {'Order', 'Camera', 'Label', 'Type', 'Note'})
    end
