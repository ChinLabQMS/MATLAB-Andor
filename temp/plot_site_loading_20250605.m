...
%%
stat = counter.process(upper_signal, 2, "calib_mode",'none','classify_method','fixed','fixed_thresholds',450);
...
figure
subplot(1, 3, 1)
imagesc(upper_y, upper_x, upper_signal(upper_x + 512, upper_y, 9))
daspect([1 1 1])
xticks([])
yticks([])
clim([0, inf])
Andor19331.plot(SiteGrid.prepareSite('Hex', 'latr', 20, 'latr_step', 5), ...
                'norm_radius', 1.5, 'diff_origin', 0, 'center', Andor19331.R)
