...
[signal, x_range, y_range] = prepareBox(signal, calib2.Andor19331.R, 150);
...
subplot(1, 2, 2)
imagesc2(y_range, x_range, signal)
calib2.Andor19331.plot()
calib2.Andor19331.plotV()

sites = SiteGrid.prepareSite("Rect", "latx_range", -20:5:20, "laty_range", -20: 5: 20);
calib2.Andor19331.plot(sites, 'color', 'w', 'norm_radius', 0.5, 'filter', true, 'x_lim', [x_range(1), x_range(end)], 'y_lim', [y_range(1), y_range(end)])
