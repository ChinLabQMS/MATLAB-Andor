...
p = Preprocessor();
Data = load("data/2025/03 March/20250325/dense_add_cooling_between.mat").Data;
Signal = p.process(Data);
wc1 = sum(Signal.Andor19330.Image(x_range, y_range, :), 'all');
wc2 = sum(Signal.Andor19330.Image(x_range + 512, y_range, :), 'all');
wcret = wc1/wc2;

%%
Data = load("data/2025/03 March/20250325/dense_no_cooling_between.mat").Data;
Signal = p.process(Data);
nc1 = sum(Signal.Andor19330.Image(x_range, y_range, :), 'all');
nc2 = sum(Signal.Andor19330.Image(x_range + 512, y_range, :), 'all');
ncret = nc1/nc2;
